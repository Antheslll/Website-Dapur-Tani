    ...
    <div className="grid grid-rows-[60px_110px]">
      <div className="pt-[20px] pl-[15%]">
        <div className="w-[90%] h-[45px] border-b-2 border-black pl-[2%]">
          <h4 className="font-[Roboto-bold] text-[23px]">Vegetable Catalog</h4>
        </div>
      </div>
        ...
        <div className="w-[90%] grid grid-rows-[50px_30px]">
          <div className="w-full grid grid-cols-[15%_85%] ">
            <div className=" grid grid-cols-[30%_70%] ">
              ...
              <div className="pl-7 pt-1 max-[900px]:pl-5 ">
                <div
                  className="scale-[80%]"
                  onClick={() => {
            ...
            <div>
              <div className="w-[80%] flex flex-row">
                ...
                />
                <button
                  className="w-[60px] h-[30px] bg-[#3F4B3B] flex justify-center items-center rounded-md absolute ml-[28%] max-[900px]:ml-[32%]"
